    ...
    <header>
  	...
  	<div id="content">
        ...
        <div>
            ...
            <input type="text" name="seatplan" value=<?php echo $seatplan;?> style="display:none">
            <?php
                $_SESSION['seatplan'] = $seatplan;
            ?>
            <input class="btn" type="submit" value="Submit" onclick="window.location.href='transaction.php'">
            </form>
        </div>
