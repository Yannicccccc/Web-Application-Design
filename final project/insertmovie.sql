INSERT INTO movie VALUES
    ...
    (3, "Poster-MaleficientMistressOfEvil-V2.jpg", "Adventure, Family, Fantasy", "Maleficient: Mistress Of Evil", "PG", 4.8, "Angelina Jolie, Elle Fanning, Chiwetel Ejiofor, Sam Riley, Imelda Staunton, Juno Temple, Lesley Manville", "Chinese", "Joachim Rønning", "2019-10-17", "A fantasy adventure that picks up several years after Maleficent, in which audiences learned of the events that hardened the heart of Disney's most notorious villain and drove her to curse a baby Princess Aurora, Maleficent: Mistress of Evil continues to explore the complex relationship between the horned fairy and the soon to be Queen, as they form new alliances and face new adversaries in their struggle to protect the moors and the magical creatures that reside within."),
